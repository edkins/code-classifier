from cc_topic import topic_extract, topic_tsne
import argparse
import os
import sqlite3
import subprocess
...
def main():
    ...
    parser_topic_tsne.add_argument('--intermediate', type=int, default=200)
    parser_topic_tsne.add_argument('--perplexity', type=int, default=30)
    parser_topic_tsne.add_argument('--filenorm', action='store_true')
    parser_topic_tsne.add_argument('--counts', action='store_true')
    parser_topic_tsne.add_argument('--log', action='store_true')
    parser_topic_tsne.add_argument('--loglog', action='store_true')
    parser_topic_tsne.add_argument('--project', action='store_true')
